...
import { LayoutDashboard, Plane, MapPin, Building2, LogOut, Users, Ticket, Hotel, Tag, Star, ServerCog, Headphones } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { name: 'Suppliers', href: '/admin/suppliers', icon: ServerCog },
