...
<body>
    <div class="container">
        ...
        <div class="content">
                ...
                @if($flight)
                    ...
                    <div class="flight-details">
                        <div class="detail-item">
                            ...
                            <span
                                class="detail-value">{{ \Carbon\Carbon::parse($flight->departure_time)->format('D, M d, Y') }}</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Departure</span>
                            <span
                                class="detail-value">{{ \Carbon\Carbon::parse($flight->departure_time)->format('H:i') }}</span>
                        </div>
                        <div class="detail-item">
            ...
            <div class="passenger-list">
                @foreach($booking->passengers as $index => $passenger)
                    <div class="passenger-item">
                        <span>{{ $index + 1 }}. {{ $passenger->first_name ?? '' }}
                            {{ $passenger->last_name ?? $passenger->name }}</span>
            ...
            <div class="info-box">
                <p>📋 <strong>Important:</strong> Please arrive at the airport at least 2 hours before your domestic
                    flight or 3 hours for international flights. Don't forget to bring a valid ID/passport.</p>
            </div>

            <a href="{{ config('branding.frontend_url', 'http://localhost:3000') }}/dashboard/tickets?booking={{ $booking->id }}"
                class="button">
                View Your Ticket
            </a>
        </div>
        ...
        <div class="footer">
            <p>Need help? Contact us at {{ config('branding.support_email', 'support@voyager.com') }}</p>
